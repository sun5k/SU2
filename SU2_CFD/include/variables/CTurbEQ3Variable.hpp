/*!
 * \file CTurbEQ3Variable.hpp
 * \brief Declaration of the variables of the EQ3 turbulence model.
 * \author S. Kang
...
/*!
 * \class CTurbEQ3Variable
 * \brief Main class for defining the variables of the turbulence model.
 * \ingroup Turbulence_Model
 * \author S. Kang
 */

class CTurbEQ3Variable final : public CTurbVariable {
protected:
  su2double sigma_om2;
  su2double beta_star;
...
public:
   ...
   */
  CTurbEQ3Variable(su2double kine, su2double omega, su2double gamma, su2double mut, unsigned long npoint,
                   unsigned long ndim, unsigned long nvar, const su2double* constants, CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbEQ3Variable() override = default;
