/*!
 * \file CTransAFMTSolver.hpp
 * \brief Headers of the CTransAFTSolver class
 * \author S. Kang
...
/*!
 * \class CTransAFMTSolver
 * \brief Main class for defining the transition model solver.
 * \ingroup Turbulence_Model
 * \author S. Kang.
 */

class CTransAFMTSolver final : public CTurbSolver {
private:
...
public:
   ...
   */
  CTransAFMTSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh);

  /*!
   * \brief Destructor of the class.
   */
  ~CTransAFMTSolver() = default;
 ...
 /*!
   ...
   */
  inline su2double GetAF_Inf(void) const override { return Solution_Inf[0]; }

  /*!
   * \brief Get the value of the intermittency.
   * \return Value of the turbulent kinetic energy.
   */
  inline su2double GetLnIntermittency_Inf(void) const override { return Solution_Inf[1]; }
