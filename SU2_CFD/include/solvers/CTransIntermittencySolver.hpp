...
/*!
 * \class CTransIntermittencySolver
 * \brief Main class for defining the transition model solver.
 * \ingroup Turbulence_Model
 * \author A. Aranake, S. Kang.
 */

class CTransIntermittencySolver final : public CTurbSolver {
private:
...
public:
   ...
   */
  CTransIntermittencySolver(CGeometry *geometry, CConfig *config, unsigned short iMesh);

  /*!
   * \brief Destructor of the class.
   */
  ~CTransIntermittencySolver() = default;
