    ...
    switch (options.Correlation) {
      ...
      case AFMT_CORRELATION::sok: {
        ...
        */
        ...
        a1 = -4.7876E-04 * pow(M_e,3)+4.4856E-02 *pow(M_e,2)- 4.6569E-01*pow(M_e,1)+ 1.2909E+00;
        a2 = 1.1647E-01 * pow(M_e,3) - 1.9661E+00 *pow(M_e,2)+ 1.1048E+01*pow(M_e,1)- 2.0787E+01;
        a3 = 1.4815E-01 * pow(M_e,3) - 2.5327E+00 *pow(M_e,2)+ 1.4421E+01*pow(M_e,1)- 2.7346E+01;
        a4 = -9.8659E-01 *pow(M_e, 3) + 1.5201E+01 *pow(M_e, 2) - 7.6834E+01*pow(M_e,1)+ 1.2688E+02;
        if(M_e > 6.0) {
          a1 = 1.4916E-02 * pow(M_e,4) - 4.1514E-01 * pow(M_e,3) + 4.3108E+00 * pow(M_e,2) - 1.9799E+01 * pow(M_e,1) + 3.3952E+01;
          a2 = -5.5040E-02 * pow(M_e, 4) +1.5906E+00*pow(M_e,3) - 1.7200E+01*pow(M_e,2) + 8.2462E+01*pow(M_e,1) - 1.4793E+02;
          a3 = -7.0808E-03 * pow(M_e,4) +1.9853E-01*pow(M_e,3) - 2.0711E+00*pow(M_e,2) +9.5341E+00*pow(M_e,1) - 1.6350E+01;
          a4 = 7.9698E-02 *pow(M_e, 4) - 2.0832E+00*pow(M_e, 3) + 2.0176E+01*pow(M_e, 2) - 8.5771E+01*pow(M_e, 1) + 1.3498E+02;
        }
