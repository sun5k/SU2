    ...
    switch (options.Correlation) {
      ...
      case AFMT_CORRELATION::sok: {
       ...
       a1 = -9.706717E-02 * pow(M_e,3 ) + 1.230110E+00 * pow(M_e,2 ) - 5.015305E+00 * pow(M_e,1 ) + 6.704398E+00;
        if(M_e >= 5.5){
          a1 = 7.028688E-03 * pow(M_e, 4) - 1.901304E-01 * pow(M_e,3 ) + 1.903909E+00 * pow(M_e,2 ) - 8.408162E+00 * pow(M_e,1 ) + 1.403497E+01;
        }

        a2 = -1.613669E-01 * pow(M_e,3 ) + 2.200844E+00 * pow(M_e,2 ) - 9.753017E+00 * pow(M_e,1 ) + 1.322605E+01;
        if(M_e >= 5.5){
         a2 = -4.498900E-02 * pow(M_e, 4) + 1.274678E+00 * pow(M_e,3 ) - 1.354774E+01 * pow(M_e,2 ) + 6.394560E+01 * pow(M_e,1 ) - 1.134777E+02;
        }

        a3 = 1.219028E-02 * pow(M_e,3 ) - 1.674853E-01 * pow(M_e,2 ) + 7.423022E-01 * pow(M_e,1 ) - 1.029622E+00;
        if(M_e >= 5.5){
         a3 = 1.113839E-03 * pow(M_e, 4) - 3.294161E-02 * pow(M_e,3 ) + 3.637598E-01 * pow(M_e,2 ) - 1.778357E+00 * pow(M_e,1 ) + 3.253391E+00;
        }

        a4 = 2.686208E-01 * pow(M_e,3 ) - 3.994842E+00 * pow(M_e,2 ) + 1.992347E+01 * pow(M_e,1 ) - 3.356816E+01;
        if(M_e >= 5.5){
         a4 = -1.080448E-02 * pow(M_e, 4) + 3.195531E-01 * pow(M_e,3 ) - 3.537927E+00 * pow(M_e,2 ) + 1.738557E+01 * pow(M_e,1 ) - 3.201851E+01;
        }
