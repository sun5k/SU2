 ...
 public:
  ...
  su2double dNdRet_Correlations(const su2double H12, const su2double M_e, const su2double T_e) const {
    ...
    switch (options.Correlation) {
      ...
      //4.3
      /*
       a1 =-1.9259259e-4 * pow(M_e, 3) * T_e + 9.0370370e-2 * pow(M_e, 3) + 3.6857143e-3 * pow(M_e, 2) * T_e - 1.6942857e+0 * pow(M_e, 2) - 2.3137566e-2 * M_e * T_e + 1.0233122e+1 * M_e + 4.7785714e-2 * T_e - 1.9531429e+1;
       a2 = -1.1851852e-4 * pow(M_e, 3) * T_e + 2.8888889e-2 * pow(M_e, 3) + 2.3142857e-3 * pow(M_e, 2) * T_e - 6.1714286e-1 * pow(M_e, 2) - 1.4570370e-2 * M_e * T_e + 4.4113492e+0 * M_e + 2.9742857e-2 * T_e - 1.1199286e+1;
       a3 = 6.3333333e-6 * pow(M_e, 4) * T_e - 1.6000000e-3 * pow(M_e, 4) - 1.7848148e-4 * pow(M_e, 3) * T_e + 4.4133333e-2 * pow(M_e, 3) + 1.8739167e-3 * pow(M_e, 2) * T_e - 4.5240000e-1 * pow(M_e, 2) - 8.6872011e-3 * M_e * T_e + 2.0405667e+0 * M_e + 1.5013107e-2 * T_e - 3.4106000e+0;
       a4 = -8.0000000e-5 * pow(M_e, 5) * T_e + 1.9466667e-2 * pow(M_e, 5) + 2.7066667e-3 * pow(M_e, 4) * T_e - 6.6266667e-1 * pow(M_e, 4) - 3.6420000e-2 * pow(M_e, 3) * T_e + 8.9836667e+0 * pow(M_e, 3) + 2.4358333e-1 * pow(M_e, 2) * T_e - 6.0644333e+1 * pow(M_e, 2) - 8.0966000e-1 * M_e * T_e + 2.0393187e+2 * M_e + 1.0698400e+0 * T_e - 2.7345000e+2;




       if (M_e < 5.5) {
        a1 = 1.4000e-3 * M_e * M_e * T_e - 4.2000e-1 * M_e * M_e - 1.3900e-2 * M_e * T_e + 4.0500e+0 * M_e + 3.4100e-2 * T_e - 9.0400e+0;
        a2 = -1.8000e-3 * M_e * M_e * T_e + 3.6000e-1 * M_e * M_e + 1.8500e-2 * M_e * T_e - 3.3200e+0 * M_e - 4.7400e-2 * T_e + 6.5700e+0;
        a3 = 2.0000e-2 * M_e * M_e - 1.0000e-5 * M_e * T_e - 2.2800e-1 * M_e + 7.5000e-5 * T_e + 6.5500e-1;
        a4 = 5.4000e-4 * M_e * M_e * T_e - 2.5400e-1 * M_e * M_e - 5.8300e-3 * M_e * T_e + 2.9130e+0 * M_e + 1.5600e-2 * T_e - 8.4050e+0;
       }

       if ( T_e < 200 ) {
        a1 = 2.7160e-4 * pow(M_e, 3) * T_e - 2.4691e-3 * pow(M_e, 3) - 6.4286e-3 * pow(M_e, 2) * T_e + 3.2857e-1 * pow(M_e, 2) + 4.8651e-2 * M_e * T_e - 4.1246e+0 * M_e - 1.1945e-1 * T_e + 1.3915e+1;
        a2 = 2.6173e-4 * pow(M_e, 3) * T_e - 4.7160e-2 * pow(M_e, 3) - 5.3524e-3 * pow(M_e, 2) * T_e + 9.1619e-1 * pow(M_e, 2) + 3.5935e-2 * M_e * T_e - 5.6896e+0 * M_e - 7.9424e-2 * T_e + 1.0634e+1;
        a3 = -8.2222e-6 * pow(M_e, 4) * T_e + 1.3111e-3 * pow(M_e, 4) + 2.1909e-4 * pow(M_e, 3) * T_e - 3.5380e-2 * pow(M_e, 3) - 2.1563e-3 * pow(M_e, 2) * T_e + 3.5364e-1 * pow(M_e, 2) + 9.2850e-3 * M_e * T_e - 1.5539e+0 * M_e - 1.4784e-2 * T_e + 2.5487e+0;
        a4 = -3.0222e-5 * pow(M_e, 4) * T_e + 1.7111e-3 * pow(M_e, 4) + 8.8030e-4 * pow(M_e, 3) * T_e - 4.8911e-2 * pow(M_e, 3) - 9.6831e-3 * pow(M_e, 2) * T_e + 5.2921e-1 * pow(M_e, 2) + 4.7688e-2 * M_e * T_e - 2.5689e+0 * M_e - 8.8661e-2 * T_e + 4.6969e+0;


        if (M_e < 5.5) {
          a1 = -2.2666670e-3 * pow(M_e, 2) * T_e + 3.1333330e-1 * pow(M_e, 2) + 2.5133330e-2 * M_e * T_e - 3.7566670e+0 * M_e - 7.0800000e-2 * T_e + 1.1940000e+1;
          a2 = 3.7895610e-18 * pow(M_e, 2) * T_e - 3.6267290e-16 * pow(M_e, 2) - 4.1333330e-3 * M_e * T_e + 1.2066670e+0 * M_e + 2.2600000e-2 * T_e - 7.4300000e+0;
          a3 = 5.7333330e-5 * pow(M_e, 2) * T_e + 8.5333330e-3 * pow(M_e, 2) - 8.3533330e-4 * M_e * T_e - 6.2933330e-2 * M_e + 2.8433330e-3 * T_e + 1.0133330e-1;
          a4 = 1.4266670e-3 * pow(M_e, 2) * T_e - 4.3133330e-1 * pow(M_e, 2) - 1.3553330e-2 * M_e * T_e + 4.4576670e+0 * M_e + 3.0900000e-2 * T_e - 1.1465000e+1;
        }
       }
       */
       ...
       //4.4
       /*
       a1 = -2.22222222e-04 * pow(M_e, 3) * T_e + 9.62962963e-02 * pow(M_e, 3) + 4.34285714e-03 * pow(M_e, 2) * T_e - 1.82571429e+00 * pow(M_e, 2) - 2.78301587e-02 * M_e * T_e + 1.11716402e+01 * M_e + 5.86571429e-02 * T_e - 2.17057143e+01;
       a2 = -2.07407407e-04 * pow(M_e, 3) * T_e + 5.03703704e-02 * pow(M_e, 3) + 4.14285714e-03 * pow(M_e, 2) * T_e - 1.06142857e+00 * pow(M_e, 2) - 2.72910053e-02 * M_e * T_e + 7.53669312e+00 * M_e + 5.97428571e-02 * T_e - 1.86907143e+01;
       a3 = -1.33333333e-06 * pow(M_e, 4) * T_e + 5.33333333e-04 * pow(M_e, 4) + 3.27407407e-05 * pow(M_e, 3) * T_e - 1.45481481e-02 * pow(M_e, 3) - 2.97666667e-04 * pow(M_e, 2) * T_e;
       a3 = a3 + 1.49866667e-01 * pow(M_e, 2) + 1.18652910e-03 * M_e * T_e - 6.92705820e-01 * M_e - 1.74057143e-03 * T_e + 1.21791429e+00;
       a4 = -6.80000000e-05 * pow(M_e, 5) * T_e + 1.42666667e-02 * pow(M_e, 5) + 2.33666667e-03 * pow(M_e, 4) * T_e - 4.95666667e-01 * pow(M_e, 4) - 3.19316667e-02 * pow(M_e, 3) * T_e ;
       a4 = a4 + 6.85516667e+00 * pow(M_e, 3) + 2.16895833e-01 * pow(M_e, 2) * T_e - 4.71920833e+01 * pow(M_e, 2) - 7.32262833e-01 * M_e * T_e + 1.61798317e+02 * M_e + 9.82935000e-01 * T_e - 2.21170500e+02;

       if (M_e < 5.5) {
        a1 = 1.40000000e-03 * pow(M_e, 2) * T_e - 4.20000000e-01 * pow(M_e, 2) - 1.39000000e-02 * M_e * T_e + 4.05000000e+00 * M_e + 3.41000000e-02 * T_e - 9.04000000e+00;
        a2 = -1.80000000e-03 * pow(M_e, 2) * T_e + 3.60000000e-01 * pow(M_e, 2) + 1.85000000e-02 * M_e * T_e - 3.32000000e+00 * M_e - 4.74000000e-02 * T_e + 6.57000000e+00;
        a3 = 2.00000000e-02 * pow(M_e, 2) - 1.00000000e-05 * M_e * T_e - 2.28000000e-01 * M_e + 7.50000000e-05 * T_e + 6.55000000e-01;
        a4 = 5.40000000e-04 * pow(M_e, 2) * T_e - 2.54000000e-01 * pow(M_e, 2) - 5.83000000e-03 * M_e * T_e + 2.91300000e+00 * M_e + 1.56000000e-02 * T_e - 8.40500000e+00;
       }

       if ( T_e < 200 ) {
        a1 = 2.71604938e-04 * pow(M_e, 3) * T_e - 2.46913580e-03 * pow(M_e, 3) - 6.42857143e-03 * pow(M_e, 2) * T_e + 3.28571429e-01 * pow(M_e, 2) + 4.86511464e-02 * M_e * T_e - 4.12462081e+00 * M_e - 1.19447619e-01 * T_e + 1.39152381e+01;
        a2 = 1.82716049e-04 * pow(M_e, 3) * T_e - 2.76543210e-02 * pow(M_e, 3) - 3.79047619e-03 * pow(M_e, 2) * T_e + 5.25238095e-01 * pow(M_e, 2) + 2.59924162e-02 * M_e * T_e - 3.11999118e+00 * M_e - 5.91952381e-02 * T_e + 5.09690476e+00;
        a3 = -1.77777778e-06 * pow(M_e, 4) * T_e + 6.22222222e-04 * pow(M_e, 4) + 4.91851852e-05 * pow(M_e, 3) * T_e - 1.78370370e-02 * pow(M_e, 3) - 4.88222222e-04 * pow(M_e, 2) * T_e;
        a3 = a3 + 1.87977778e-01 * pow(M_e, 2) + 2.05270370e-03 * M_e * T_e - 8.65940741e-01 * M_e - 3.08633333e-03 * T_e + 1.48706667e+00;
        a4 = -4.22222222e-05 * pow(M_e, 4) * T_e + 2.61111111e-03 * pow(M_e, 4) + 1.18325926e-03 * pow(M_e, 3) * T_e - 7.02259259e-02 * pow(M_e, 3) - 1.25214444e-02 * pow(M_e, 2) * T_e ;
        a4 = a4 + 7.14497222e-01 * pow(M_e, 2) + 5.94042804e-02 * M_e * T_e - 3.27187328e+00 * M_e - 1.06698476e-01 * T_e + 5.68824881e+00;


        if (M_e < 5.5) {
          a1 = -2.66666667e-04 * pow(M_e, 2) * T_e - 8.66666667e-02 * pow(M_e, 2) + 4.13333333e-03 * M_e * T_e + 4.43333333e-01 * M_e - 1.58000000e-02 * T_e + 9.40000000e-01;
          a2 = -1.33333333e-03 * pow(M_e, 2) * T_e + 1.66666667e-01 * pow(M_e, 2) + 9.20000000e-03 * M_e * T_e - 5.10000000e-01 * M_e - 1.07333333e-02 * T_e - 3.01333333e+00;
          a3 = 9.60000000e-05 * pow(M_e, 2) * T_e + 2.20000000e-03 * pow(M_e, 2) - 1.21200000e-03 * M_e * T_e - 9.00000000e-04 * M_e + 3.75333333e-03 * T_e - 4.91666667e-02;
          a4 = 9.46666667e-04 * pow(M_e, 2) * T_e - 3.73333333e-01 * pow(M_e, 2) - 8.71333333e-03 * M_e * T_e + 3.87066667e+00 * M_e + 1.87666667e-02 * T_e - 9.98333333e+00;
        }
       }
      ...
      /*
       ...
       a1 = 2.88888889e-04 * pow(M_e, 3) * T_e - 5.70370370e-02 * pow(M_e, 3) - 6.20000000e-03 * pow(M_e, 2) * T_e + 1.33714286e+00 * pow(M_e, 2) + 4.39277778e-02 * M_e * T_e - 1.03557407e+01 * M_e - 1.02150000e-01 * T_e + 2.65364286e+01;
       a2 = -2.62962963e-04 * pow(M_e, 3) * T_e + 7.44444444e-02 * pow(M_e, 3) + 5.17142857e-03 * pow(M_e, 2) * T_e - 1.52714286e+00 * pow(M_e, 2) - 3.36414021e-02 * M_e * T_e + 1.05471032e+01 * M_e + 7.28250000e-02 * T_e - 2.51925000e+01;
       a3 = -3.06666667e-06 * pow(M_e, 4) * T_e + 1.22000000e-03 * pow(M_e, 4) + 7.78222222e-05 * pow(M_e, 3) * T_e - 3.27577778e-02 * pow(M_e, 3) - 7.28633333e-04 * pow(M_e, 2) * T_e;
       a3 = a3 + 3.28365000e-01 * pow(M_e, 2) + 2.97270159e-03 * M_e * T_e - 1.45740413e+00 * M_e - 4.43008571e-03 * T_e + 2.42235786e+00;
       a4 = 5.00000000e-05 * pow(M_e, 4) * T_e - 1.56666667e-02 * pow(M_e, 4) - 1.30555556e-03 * pow(M_e, 3) * T_e + 4.21370370e-01 * pow(M_e, 3) + 1.26725000e-02 * pow(M_e, 2) * T_e;
       a4 = a4 - 4.24258333e+00 * pow(M_e, 2) - 5.41853968e-02 * M_e * T_e + 1.89802646e+01 * M_e + 8.60039286e-02 * T_e - 3.18805357e+01;

       if (M_e < 5.5) {
        a1 = 1.20000000e-03 * pow(M_e, 2) * T_e - 3.80000000e-01 * pow(M_e, 2) - 1.18000000e-02 * M_e * T_e + 3.63000000e+00 * M_e + 2.86000000e-02 * T_e - 7.94000000e+00;
        a2 = -6.00000000e-04 * pow(M_e, 2) * T_e + 1.20000000e-01 * pow(M_e, 2) + 7.50000000e-03 * M_e * T_e - 1.20000000e+00 * M_e - 2.26000000e-02 * T_e + 1.97000000e+00;
        a3 = 8.00000000e-05 * pow(M_e, 2) * T_e + 2.00000000e-03 * pow(M_e, 2) - 8.90000000e-04 * M_e * T_e - 3.20000000e-02 * M_e + 2.49500000e-03 * T_e + 1.21500000e-01;
        a4 = 7.80000000e-04 * pow(M_e, 2) * T_e - 3.24000000e-01 * pow(M_e, 2) - 8.23000000e-03 * M_e * T_e + 3.62200000e+00 * M_e + 2.15400000e-02 * T_e - 1.01780000e+01;
       }

       if ( T_e < 200 ) {
        a1 = -6.91358025e-05 * pow(M_e, 3) * T_e + 1.45679012e-02 * pow(M_e, 3) + 6.00000000e-04 * pow(M_e, 2) * T_e - 2.28571429e-02 * pow(M_e, 2) + 8.12522046e-04 * M_e * T_e - 1.73268959e+00 * M_e - 1.22428571e-02 * T_e + 8.55500000e+00;
        a2 = 2.69135802e-04 * pow(M_e, 3) * T_e - 3.19753086e-02 * pow(M_e, 3) - 5.52380952e-03 * pow(M_e, 2) * T_e + 6.11904762e-01 * pow(M_e, 2) + 3.75946208e-02 * M_e * T_e - 3.70010141e+00 * M_e - 8.50976190e-02 * T_e + 6.39202381e+00;
        a3 = 4.88888889e-07 * pow(M_e, 4) * T_e + 5.08888889e-04 * pow(M_e, 4) - 1.21037037e-05 * pow(M_e, 3) * T_e - 1.47725926e-02 * pow(M_e, 3) + 1.27144444e-04 * pow(M_e, 2) * T_e;
        a3 = a3 + 1.57209444e-01 * pow(M_e, 2) - 6.63721693e-04 * M_e * T_e - 7.30119471e-01 * M_e + 1.35727143e-03 * T_e + 1.26488643e+00;
        a4 = -4.11111111e-05 * pow(M_e, 4) * T_e + 2.55555556e-03 * pow(M_e, 4) + 1.14214815e-03 * pow(M_e, 3) * T_e - 6.81703704e-02 * pow(M_e, 3) - 1.19767222e-02 * pow(M_e, 2) * T_e;
        a4 = a4 + 6.87261111e-01 * pow(M_e, 2) + 5.62989630e-02 * M_e * T_e - 3.11660741e+00 * M_e - 1.00220500e-01 * T_e + 5.36435000e+00;

        if (M_e < 5.5) {
          a1 = -2.66666667e-04 * pow(M_e, 2) * T_e - 8.66666667e-02 * pow(M_e, 2) + 4.13333334e-03 * M_e * T_e + 4.43333333e-01 * M_e - 1.58000000e-02 * T_e + 9.40000000e-01;
          a2 = -6.66666667e-04 * pow(M_e, 2) * T_e + 1.33333333e-01 * pow(M_e, 2) + 2.33333333e-03 * M_e * T_e - 1.66666667e-01 * M_e + 6.66666667e-03 * T_e - 3.88333333e+00;
          a3 = 7.33333333e-05 * pow(M_e, 2) * T_e + 3.33333333e-03 * pow(M_e, 2) - 9.90000000e-04 * M_e * T_e - 1.20000000e-02 * M_e + 3.21333333e-03 * T_e - 2.21666667e-02;
          a4 = 1.05333333e-03 * pow(M_e, 2) * T_e - 3.78666667e-01 * pow(M_e, 2) - 9.72666667e-03 * M_e * T_e + 3.92133333e+00 * M_e + 2.11666667e-02 * T_e - 1.01033333e+01;
        }
       }
       su2double mindNdRet = 8.411474E-05 * pow(M_e, 3) - 9.546653E-04 * pow(M_e, 2) - 1.609030E-03 * pow(M_e, 1) + 3.550163E-02;
        if (T_e < 200){
          mindNdRet = mindNdRet * (2.6267E-05 * pow(T_e,2) - 1.3233E-02 * T_e + 2.596 );
        }
       */
      ...
      //4.6
       ...
       if ( T_e < 200 ) {
        a1 = -2.03932450e-04 * pow(M_e, 3) * T_e + 4.15087828e-02 * pow(M_e, 3) + 3.45248414e-03 * pow(M_e, 2) * T_e - 5.92998186e-01 * pow(M_e, 2) - 1.91957315e-02 * M_e * T_e + 2.26668877e+00 * M_e + 3.42674133e-02 * T_e - 7.42247418e-01;
        a2 = 2.19819709e-04 * pow(M_e, 3) * T_e - 2.21020965e-02 * pow(M_e, 3) - 4.47747536e-03 * pow(M_e, 2) * T_e + 4.02445197e-01 * pow(M_e, 2) + 3.00437446e-02 * M_e * T_e - 2.18869516e+00 * M_e - 6.60483108e-02 * T_e + 2.57955840e+00;
        a3 = 4.48101778e-06 * pow(M_e, 4) * T_e - 2.90717556e-04 * pow(M_e, 4) - 1.24838202e-04 * pow(M_e, 3) * T_e + 7.80487306e-03 * pow(M_e, 3) + 1.30750805e-03 * pow(M_e, 2) * T_e ;
        a3 = a3 - 7.91587356e-02 * pow(M_e, 2) - 6.10282372e-03 * M_e * T_e + 3.58964731e-01 * M_e + 1.07156257e-02 * T_e - 6.08802715e-01;
        a4 = -4.54624422e-05 * pow(M_e, 4) * T_e + 3.43511711e-03 * pow(M_e, 4) + 1.26245375e-03 * pow(M_e, 3) * T_e - 9.24721382e-02 * pow(M_e, 3) - 1.32125907e-02 * pow(M_e, 2) * T_e ;
        a4 = a4 + 9.36760965e-01 * pow(M_e, 2) + 6.18809589e-02 * M_e * T_e - 4.24295641e+00 * M_e - 1.09554004e-01 * T_e + 7.24694076e+00;


        if (M_e < 5.5) {
          a1 = 4.29634600e-04 * pow(M_e, 2) * T_e - 2.21481728e-01 * pow(M_e, 2) - 2.48152870e-03 * M_e * T_e + 1.72407642e+00 * M_e - 1.33221493e-04 * T_e - 2.09333888e+00;
          a2 = 1.36931276e-03 * pow(M_e, 2) * T_e - 2.68465618e-01 * pow(M_e, 2) - 1.70084712e-02 * M_e * T_e + 3.65042337e+00 * M_e + 5.24762037e-02 * T_e - 1.29238097e+01;
          a3 = 9.19522133e-05 * pow(M_e, 2) * T_e - 3.97610667e-04 * pow(M_e, 2) - 1.09354603e-03 * M_e * T_e + 8.77730133e-03 * M_e + 3.26559147e-03 * T_e - 3.27795733e-02;
          a4 = -1.03296040e-03 * pow(M_e, 2) * T_e + 3.86480000e-02 * pow(M_e, 2) + 1.22131237e-02 * M_e * T_e - 4.67155987e-01 * M_e - 3.63749420e-02 * T_e + 1.40624661e+00;
        }
       }
