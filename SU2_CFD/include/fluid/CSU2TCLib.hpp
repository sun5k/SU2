...
public:
   ...
   */
  vector<su2double>& GetThermalConductivities(su2double Mu_e) final;
  ...
  */
   ...
   */
  void ThermalConductivitiesWBE(su2double Mu_e);
   ...
   */
  void ThermalConductivitiesGY(su2double Mu_e);
   ...
   */
  void ThermalConductivitiesSuth(su2double Mu_e);
