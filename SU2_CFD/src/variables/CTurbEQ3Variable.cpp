...
CTurbEQ3Variable::CTurbEQ3Variable(su2double kine, su2double omega, su2double gamma, su2double mut, unsigned long npoint, unsigned long ndim, unsigned long nvar, const su2double* constants, CConfig *config)
...
void CTurbEQ3Variable::SetBlendingFunc(unsigned long iPoint, su2double val_viscosity,
