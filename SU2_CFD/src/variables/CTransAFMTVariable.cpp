...
CTransAFMTVariable::CTransAFMTVariable(su2double AF, su2double LnIntermittency, unsigned long npoint, unsigned long ndim, unsigned long nvar, CConfig *config)
