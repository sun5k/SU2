...
void CFlowOutput::AddHistoryOutputFields_ScalarMAX_RES(const CConfig* config) {
  ...
  switch (config->GetKind_Trans_Model()) {
    ...
    case TURB_TRANS_MODEL::INTERMITTENCY :
      /// DESCRIPTION: Maximum residual of the intermittency (Intermittency model).
      AddHistoryOutput("MAX_INTERMITTENCY", "max[Intermit]",  ScreenOutputFormat::FIXED, "MAX_RES", "Maximum residual of the intermittency (Intermittency model).", HistoryFieldType::RESIDUAL) ;
      break;
...
void CFlowOutput::SetVolumeOutputFieldsScalarResidual(const CConfig* config) {
  ...
  switch (config->GetKind_Trans_Model()) {
    ...
    case TURB_TRANS_MODEL::INTERMITTENCY :
      AddVolumeOutput("RES_INTERMITTENCY", "Residual_Intermittency", "RESIDUAL", "Residual of Intermittency");
      break;
...
void CFlowOutput::LoadVolumeDataScalar(const CConfig* config, const CSolver* const* solver, const CGeometry* geometry,
  ...
  switch (config->GetKind_Trans_Model()) {
    case TURB_TRANS_MODEL::LM:
      ...
      SetVolumeOutputValue("HL", iPoint, Node_Trans->GetAFMT_Wonder_Func_var1(iPoint));
      SetVolumeOutputValue("Hk", iPoint, Node_Trans->GetAFMT_Wonder_Func_var2(iPoint));
      SetVolumeOutputValue("H12", iPoint, Node_Trans->GetAFMT_Wonder_Func_var3(iPoint));
      SetVolumeOutputValue("dNdRet", iPoint, Node_Trans->GetAFMT_Wonder_Func_var4(iPoint));
      SetVolumeOutputValue("Ret0", iPoint, Node_Trans->GetAFMT_Wonder_Func_var5(iPoint));
      SetVolumeOutputValue("F_growth", iPoint, Node_Trans->GetAFMT_Wonder_Func_var6(iPoint));
      SetVolumeOutputValue("D_H12", iPoint, Node_Trans->GetAFMT_Wonder_Func_var7(iPoint));
      SetVolumeOutputValue("l_H12", iPoint, Node_Trans->GetAFMT_Wonder_Func_var8(iPoint));
      SetVolumeOutputValue("Ret", iPoint, Node_Trans->GetAFMT_Wonder_Func_var9(iPoint));
      SetVolumeOutputValue("F_crit", iPoint, Node_Trans->GetAFMT_Wonder_Func_var10(iPoint));
